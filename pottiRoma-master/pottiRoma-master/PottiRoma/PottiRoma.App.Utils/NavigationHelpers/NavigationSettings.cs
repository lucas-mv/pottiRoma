...
namespace PottiRoma.App.Utils.NavigationHelpers
{
    ...
    {
        public const string Login = "app:///LoginPage";
        ...
        public const string ListClients = "MenuPrincipalPage/ListClientsPage";
        public const string RegisterClient = "MenuPrincipalPage/RegisterClientsPage";
        public const string RegisterSale = "RegisterSalePage";
        public const string ResetPassword = "MenuPrincipalPage/ResetPasswordPage";
        public const string Ranking = "MainNavigationPage/RankingPage";
